...
public class BicicletaServiceImpl implements TallerService{
	
	@Override
	public void recibir(Vehiculo vehiculo) {
		vehiculo.setEstado(EstadoVehiculo.RECIBIDO);
		System.out.println("RECIBIENDO Bicicleta-> " +vehiculo.toString());
	}

	@Override
	public void reparar(Vehiculo vehiculo) {
		vehiculo.setEstado(EstadoVehiculo.REPARANDO);
		System.out.println("REPARANDO Bicicleta-> " +vehiculo.toString());
	...
	public void entregar(Vehiculo vehiculo) {
		...
		System.out.println("ENTREGANDO Bicicleta-> " +vehiculo.toString());
